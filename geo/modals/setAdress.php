        ...
        <div class="w3-modal-content w3-card-4 w3-round" style="max-width:30vw">
          <div class="w3-center"><br>
            ...
            <div class="w3-container w3-section">
              <label>Since you have enabled <b>Geolocation</b> for this post, you can set the address so people can see where this upload was taken! Fill in the address in the input below and you will be all set!</label><br>
              <input type="text" id="geoAddress" placeholder="Address">
            </div>
          <div class="w3-container w3-border-top w3-padding-16 w3-light-grey w3-round">
            ...
            <button id="setLocation" type="button" class="w3-button w3-green w3-right">Set address!</button>             
          </div>
        </div>
      </div>
  ...
  function getCoordinates(address) {
    ...
    geocoder.geocode({address: address}, function(results, status) {
      ...
      <?php echo 'var name = "'.$fetchGeo['upload_name'].'";'; ?>
      ...
      $("#setLocation").on("click", function(data) {
